...
export default function SignupPage() {
  ...
  const handleSignup = async (data: SignupFormData) => {
    ...
    try {
      ...
      const { data: existingUsers } = await supabase.from("profiles").select("id").eq("email", data.email).limit(1);
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription className="pt-4 text-left space-y-3">
              <p>회원가입이 완료되었습니다.</p>
              <p>
                강사 신청은 <strong>관리자 승인 후</strong> 처리됩니다. 승인이 완료되면 강사로 전환되어 강의 등록 및 PT
                제공이 가능합니다.
              </p>
              <p className="text-sm text-muted-foreground">
                승인까지 1~2일 정도 소요될 수 있습니다. 그동안 수강생으로 서비스를 이용하실 수 있습니다.
              </p>
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <Button onClick={handleInstructorModalClose}>확인</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
              ...
              <form onSubmit={handleSubmit(handleSignup)}>
                <div className="flex flex-col gap-4">
                  ...
                  <div className="grid gap-2">
                    ...
                    <Input id="displayName" type="text" placeholder="홍길동" {...register("displayName")} />
                  ...
                  <div className="grid gap-2">
                    ...
                    <p className="text-xs text-muted-foreground">8자 이상, 대문자, 소문자, 특수문자 포함</p>
                        ...
                        <RadioGroup value={field.value} onValueChange={field.onChange} className="grid gap-2">
                          ...
                          >
                            ...
                            <div className="grid gap-0.5">
                              ...
                              <p className="text-xs text-muted-foreground">강의를 수강하고 PT를 신청합니다</p>
                            </div>
                          </label>
                          <label
                            htmlFor="instructor"
                          ...
                          >
                            ...
                            <div className="grid gap-0.5">
                              ...
                              <p className="text-xs text-muted-foreground">강의를 공유하고 PT를 제공합니다</p>
                            </div>
                          </label>
                        </RadioGroup>
                      )}
                      ...
                      render={({ field }) => (
                        <div className="grid gap-2">
                          {AVAILABLE_SPORTS.map((sport) => (
                            <div key={sport} className="flex items-center space-x-3 rounded-lg border p-3">
                              <Checkbox
                                id={sport}
